...
//--------into routine in monitor--------------
    ...
    if (state_condvar[LEFT] != EATING && state_condvar[RIGHT] != EATING) {
        cprintf("phi_take_forks_condvar: state_condvar[%d] will eating\n",i);
        state_condvar[i] = EATING;
    } else {
        cprintf("phi_take_forks_condvar: wait self_cv[%d] \n",i);
        cond_wait(&(mtp->cv[i]));
    }
